    ...
    <section className="relative flex h-[90vh] w-full flex-col overflow-hidden text-white md:h-[100vh]">
          ...
          <div className="w-full">
            <div className="flex w-full flex-row items-stretch gap-3 overflow-hidden rounded-xl border border-white/10 bg-black/30 sm:items-center sm:gap-0">
              <div className="w-full pl-6">
                <Input
                  className="h-14 w-full border-none bg-transparent font-geistMono text-sm text-white placeholder:text-gray-500 focus:outline-none focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0"
      ...
      <div className="absolute right-4 bottom-[25%] z-20 hidden sm:right-10 sm:bottom-[20%] sm:block">
        <Button
          ...
          variant="ghost"
          className="group relative h-auto cursor-pointer flex-col items-center bg-transparent p-0 hover:bg-transparent"
          onClick={scrollToTop}
        >
