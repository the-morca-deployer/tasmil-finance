    ...
    >
      ...
      <div className="md:hidden">
        <Button
          variant="ghost"
          size="icon"
          className="rounded-md text-white hover:bg-white/5"
      ...
      {isMobileMenuOpen && (
        <>
          ...
          <Button
            ...
            variant="ghost"
            className="fixed inset-0 z-[999] h-auto w-full rounded-none bg-black/70 p-0 backdrop-blur-md hover:bg-black/70"
            onClick={toggleMobileMenu}
            ...
            >
              <div className="flex items-center gap-2.5">
                <Button
                  variant="ghost"
                  size="icon"
                  className="relative overflow-hidden rounded-full text-white hover:bg-white/10"
                  onClick={toggleMobileMenu}
                  type="button"
                >
                  <X className="h-6 w-6" />
              ...
              <div className="inline-flex w-full flex-col items-start">
                {menuItems.map((item) => (
                  <Button
                    variant="ghost"
                    key={item.label}
                    className="h-auto w-full justify-between rounded-none border-white/10 border-b px-4 py-8 text-left hover:bg-white/5"
                    onClick={() => {
