    ...
    <footer className="footer">
      <div className="foot-aurora" aria-hidden="true">
        <div className="fa-cols">
          <span className="fa-col" style={{ "--h": "30%" } as React.CSSProperties}></span>
          <span className="fa-col" style={{ "--h": "46%" } as React.CSSProperties}></span>
          <span className="fa-col" style={{ "--h": "60%" } as React.CSSProperties}></span>
          <span className="fa-col" style={{ "--h": "72%" } as React.CSSProperties}></span>
          <span className="fa-col" style={{ "--h": "60%" } as React.CSSProperties}></span>
          <span className="fa-col" style={{ "--h": "46%" } as React.CSSProperties}></span>
          <span className="fa-col" style={{ "--h": "30%" } as React.CSSProperties}></span>
        </div>
      ...
      <div className="wrap">
        <div className="foot-grid">
          <div className="foot-brand">
            <a className="brand" href="/quest">
              <img className="mk" src="/tasmil-logo.png" alt="Tasmil Finance" width="48" height="48" />
        ...
        <div className="foot-bottom">
          <div className="foot-legal">
            <span className="copy">&copy; 2026 Tasmil Finance. All rights reserved.</span>
            For informational purposes only, not financial advice. DeFi yields are variable and
            capital is at risk.
          </div>
          <a className="foot-x" href="https://x.com/tasmilfinance" target="_blank" rel="noopener" aria-label="X">
