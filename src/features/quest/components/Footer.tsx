...
const Footer: React.FC = () => {
  return (
    <footer className="qf">
        ...
        <div className="qf-grid">
          ...
          <div className="qf-brand">
            ...
            <p className="qf-brand-desc">
              The premier questing platform for the Tasmil ecosystem. Earn rewards, verify
              on-chain activity, and boost your profile.
            </p>
          </div>
      ...
      {/* Ghost watermark */}
      <div className="qf-mark" aria-hidden="true">Tasmil Finance</div>

      {/* Bottom: social + copyright */}
      <div className="qf-wrap qf-bottom-wrap">
        <div className="qf-bottom">
          <div className="qf-social">
            <a href={LINKS.x} target="_blank" rel="noreferrer" aria-label="X (Twitter)" className="qf-social-ic">
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
            </a>
            <a href={LINKS.telegram} target="_blank" rel="noreferrer" aria-label="Telegram" className="qf-social-ic">
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <a href={LINKS.website} target="_blank" rel="noreferrer" aria-label="Website" className="qf-social-ic">
