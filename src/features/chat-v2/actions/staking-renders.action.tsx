...
import { StakingInfoCard, StakingOperationCard } from "./components";
...
export function useStakingReadOnlyRenders() {
  useRenderToolCall({
    ...
    render: ({ args, result, status }) => (
      <StakingInfoCard type="user_stake" args={args} result={result} status={mapStatus(status)} />
    ),
  });
  ...
  useRenderToolCall({
    ...
    render: ({ args, result, status }) => (
      <StakingInfoCard type="lockup_info" args={args} result={result} status={mapStatus(status)} />
    ),
  });
...
export function useStakingWalletTools() {
  useHumanInTheLoop({
    ...
    description:
      "Stake tokens to a validator on U2U Network. When calling this tool, first tell the user: 'I've prepared the staking transaction for you. Please review the details and click the button to sign the transaction with your wallet.' User must sign the transaction.",
    parameters: [
      {
        name: "validatorID",
        type: "string",
        description: "Validator ID to stake to",
        required: true,
      },
  ...
  useHumanInTheLoop({
    ...
    description:
      "Unstake tokens from a validator on U2U Network. When calling this tool, first tell the user: 'I've prepared the unstaking transaction. Please review the details and click the button to sign the transaction with your wallet.' User must sign the transaction.",
    parameters: [
      {
        name: "validatorID",
        type: "string",
        description: "Validator ID to unstake from",
        required: true,
      },
  ...
  useHumanInTheLoop({
    ...
    description:
      "Claim pending staking rewards from a validator. When calling this tool, first tell the user: 'I've prepared the claim rewards transaction. Please review and click the button to sign the transaction with your wallet.' User must sign the transaction.",
    parameters: [
      {
        name: "validatorID",
        type: "string",
        description: "Validator ID to claim rewards from",
        required: true,
      },
    ],
    followUp: true,
  ...
  useHumanInTheLoop({
    ...
    description:
      "Compound/restake rewards back to the validator. When calling this tool, first tell the user: 'I've prepared the restake rewards transaction. Please review and click the button to sign the transaction with your wallet.' User must sign the transaction.",
    parameters: [
      {
        name: "validatorID",
        type: "string",
        description: "Validator ID to restake rewards to",
        required: true,
      },
    ],
    followUp: true,
  ...
  useHumanInTheLoop({
    ...
    description:
      "Lock stake for bonus rewards. When calling this tool, first tell the user: 'I've prepared the lock stake transaction. Please review the lock duration and click the button to sign the transaction with your wallet.' User must sign the transaction.",
    parameters: [
