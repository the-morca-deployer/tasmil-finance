...
class MessageAdapter {
  ...
  toCopilotKit(msg: UniversalMessage): CopilotMessage {
    return {
      ...
      content:
        typeof msg.content === "string" ? msg.content : this.contentBlocksToString(msg.content),
  ...
  private mapLangGraphContent(content: LangGraphMessage["content"]): UniversalMessage["content"] {
    console.log(
      "[MessageAdapter] mapLangGraphContent input type:",
      typeof content,
      "value:",
