...
export function MilestoneNudge({ type, topPercent, spotsLeft, onReinvest }: MilestoneNudgeProps) {
  if (type === "five-dollar") {
    return (
      <div className="rounded-xl border border-yellow-700/40 bg-yellow-950/20 px-4 py-3 text-sm text-yellow-200">
  ...
  return (
    <div className="rounded-xl border border-orange-700/40 bg-orange-950/20 px-4 py-3 text-sm text-orange-200">
