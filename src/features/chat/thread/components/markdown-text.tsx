...
const defaultComponents: any = {
  ...
  p: ({ className, ...props }: { className?: string }) => (
    <p className={cn("mt-4 mb-4 text-sm leading-6 first:mt-0 last:mb-0", className)} {...props} />
  ),
  ...
  ul: ({ className, ...props }: { className?: string }) => (
    <ul className={cn("my-4 ml-6 list-disc text-sm [&>li]:mt-1.5", className)} {...props} />
  ),
  ol: ({ className, ...props }: { className?: string }) => (
    <ol className={cn("my-4 ml-6 list-decimal text-sm [&>li]:mt-1.5", className)} {...props} />
  ),
    ...
    if (match) {
      ...
      return (
        <>
          ...
          <SyntaxHighlighter language={language || "text"} className={className || ""}>
            {code}
          </SyntaxHighlighter>
        </>
      );
