...
const POOLS_PANEL: PanelConfig = {
  ...
  method: "GET",
  fields: [],
  description: "List all pools/vaults on the current network",
};
...
const YIELD_PANEL: PanelConfig = {
  ...
  method: "GET",
  fields: [],
  description: "Yield opportunities via getYieldOpportunities()",
};
...
const MARKETS_PANEL: PanelConfig = {
  ...
  method: "GET",
  fields: [],
  description: "All lending markets via getLendingMarkets()",
};
