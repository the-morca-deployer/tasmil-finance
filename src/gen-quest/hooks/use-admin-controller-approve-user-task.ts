...
export function adminControllerApproveUserTaskMutationOptions<TContext = unknown>(
...
export function useAdminControllerApproveUserTask<TContext>(
  ...
  const baseOptions = adminControllerApproveUserTaskMutationOptions(config) as UseMutationOptions<
    AdminControllerApproveUserTaskMutationResponse,
    ResponseErrorConfig<Error>,
    { id: AdminControllerApproveUserTaskPathParams["id"] },
    TContext
