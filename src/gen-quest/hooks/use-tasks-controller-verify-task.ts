...
export function tasksControllerVerifyTaskMutationOptions<TContext = unknown>(
...
export function useTasksControllerVerifyTask<TContext>(
  ...
  const baseOptions = tasksControllerVerifyTaskMutationOptions(config) as UseMutationOptions<
    TasksControllerVerifyTaskMutationResponse,
    ResponseErrorConfig<Error>,
    { id: TasksControllerVerifyTaskPathParams["id"] },
    TContext
