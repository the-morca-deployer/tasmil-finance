...
export function campaignsControllerClaimCampaignMutationOptions<TContext = unknown>(
...
export function useCampaignsControllerClaimCampaign<TContext>(
  ...
  const baseOptions = campaignsControllerClaimCampaignMutationOptions(config) as UseMutationOptions<
    CampaignsControllerClaimCampaignMutationResponse,
    ResponseErrorConfig<Error>,
    { id: CampaignsControllerClaimCampaignPathParams["id"] },
    TContext
