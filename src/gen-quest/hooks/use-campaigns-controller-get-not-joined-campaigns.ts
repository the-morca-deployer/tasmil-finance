...
export function campaignsControllerGetNotJoinedCampaignsQueryOptions(
  params?: CampaignsControllerGetNotJoinedCampaignsQueryParams,
...
export function useCampaignsControllerGetNotJoinedCampaigns<
  ...
  TQueryData = CampaignsControllerGetNotJoinedCampaignsQueryResponse,
  TQueryKey extends QueryKey = CampaignsControllerGetNotJoinedCampaignsQueryKey,
>(
  params?: CampaignsControllerGetNotJoinedCampaignsQueryParams,
  options: {
    query?: Partial<
  ...
  const queryKey =
    resolvedOptions?.queryKey ?? campaignsControllerGetNotJoinedCampaignsQueryKey(params);
