...
export function tasksControllerRecordVisitMutationOptions<TContext = unknown>(
...
export function useTasksControllerRecordVisit<TContext>(
  ...
  const baseOptions = tasksControllerRecordVisitMutationOptions(config) as UseMutationOptions<
    TasksControllerRecordVisitMutationResponse,
    ResponseErrorConfig<Error>,
    { id: TasksControllerRecordVisitPathParams["id"] },
    TContext
