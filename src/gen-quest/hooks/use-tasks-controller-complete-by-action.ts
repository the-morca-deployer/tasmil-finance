...
export function tasksControllerCompleteByActionMutationOptions<TContext = unknown>(
...
export function useTasksControllerCompleteByAction<TContext>(
  ...
  const baseOptions = tasksControllerCompleteByActionMutationOptions(config) as UseMutationOptions<
    TasksControllerCompleteByActionMutationResponse,
    ResponseErrorConfig<Error>,
    void,
    TContext
