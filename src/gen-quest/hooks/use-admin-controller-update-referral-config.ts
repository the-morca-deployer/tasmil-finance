...
import type { AdminControllerUpdateReferralConfigMutationRequest, AdminControllerUpdateReferralConfigMutationResponse, AdminControllerUpdateReferralConfigPathParams } from "@/gen-quest/types/admin-controller-update-referral-config";
...
export const adminControllerUpdateReferralConfigMutationKey = () => [{ url: '/api/admin/referral/config/:layer' }] as const
