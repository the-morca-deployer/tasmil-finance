 ...
 */
export async function portfolioControllerGetHistory(address: PortfolioControllerGetHistoryPathParams["address"], params?: PortfolioControllerGetHistoryQueryParams, config: Partial<RequestConfig> & { client?: Client } = {}) {
