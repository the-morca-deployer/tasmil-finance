...
export function ChatHistoryWrapper() {
  ...
  return (
    <div className="flex h-full w-full flex-col bg-sidebar">
      ...
      <div className="flex shrink-0 items-end justify-between border-sidebar-border border-b">
        <div className="flex translate-y-px gap-0">
          <button
            type="button"
            onClick={() => setTab("history")}
            className={cn(
              "rounded-t-lg border border-b-0 px-4 py-2 font-medium text-sm transition-colors",
              tab === "history"
                ? "border-sidebar-border bg-sidebar text-sidebar-foreground"
                : "border-transparent text-sidebar-foreground/50 hover:bg-sidebar-accent/40 hover:text-sidebar-foreground"
            )}
          >
            History
          </button>
        ...
        <button
          ...
          className="mr-1 mb-1 flex h-7 w-7 items-center justify-center rounded hover:bg-sidebar-accent"
        >
