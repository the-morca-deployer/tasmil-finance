...
test.describe("Staking Workflow", () => {
  ...
  test("should complete full staking process", async ({ page, mockWallet, stakingPage }) => {
    // Connect wallet
  ...
  test("should handle staking errors gracefully", async ({ page, mockWallet, stakingPage }) => {
    await mockWallet.connect();
    await stakingPage.navigateToStaking();
