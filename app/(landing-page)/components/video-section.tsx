      ...
      <div className="relative z-10 flex w-full max-w-6xl flex-col items-center gap-16">
        ...
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <div className="max-w-2xl">
            <Typography
              ...
              variant="p"
            >
              Watch how our AI-powered DeFi platform transforms your U2U
              blockchain trading experience with intelligent automation and
              real-time insights.
            </Typography>
          </div>
        </div>
        ...
        <div className="mt-8 grid w-full grid-cols-1 gap-8 md:grid-cols-3">
          <div className="text-center">
            <Typography
              className="mb-4 font-semibold text-2xl text-white md:text-3xl"
              variant="h3"
            >
              AI-Powered Trading
            </Typography>
          ...
          <div className="text-center">
            ...
            <Typography
              ...
              variant="p"
            >
              Connect with U2U's major DeFi protocols and manage your portfolio
              from a single, intuitive interface built for U2U blockchain.
            </Typography>
          </div>
          ...
          <div className="text-center">
            ...
            <Typography
              ...
              variant="p"
            >
              Get instant insights into U2U market conditions, portfolio
              performance, and trading opportunities across the U2U ecosystem.
            </Typography>
          </div>
        </div>
      </div>
